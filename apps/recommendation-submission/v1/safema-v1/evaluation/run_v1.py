...
sys.path[:0] = [str(REPOSITORY_ROOT / "safema-v1"), str(APP_VERSION_ROOT / "base-app")]
...
def _runtime(directory: Path):
    return install(
        effect_models_path=INTEGRATION_ROOT / "models/api-effects-v1.yaml",
        origins_path=INTEGRATION_ROOT / "models/trusted-origins-v1.yaml",
        policy_path=INTEGRATION_ROOT / "policies/recommendation-disclosure-v1.yaml",
