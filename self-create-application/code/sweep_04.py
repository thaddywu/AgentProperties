"""sweep-04: does stating the implicit rule fix it?
...
(OPENAI_BASE_URL=http://127.0.0.1:18080/v1), which serves resolved model ids: `gpt-5.6-sol`. Writes to ../results/sweep-04/ only; the
...
CELLS = os.environ.get("CELLS", "base,base-explicit").split(",")
N = int(os.environ.get("N", "20"))
MODEL = os.environ.get("MODEL", "gpt-5.6-sol")
OUT = "../results/sweep-04"
