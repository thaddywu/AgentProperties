...
| Directory | Contents |
|---|---|
| [`design/`](design/) | [`v0.md`](design/v0.md) — the scenario and why the property needs both lifecycle and information flow. [`tasks.md`](design/tasks.md) — T1–T8. [`property.md`](design/property.md) — the property formally, and how the checker computes it. [`trace-walkthrough.md`](design/trace-walkthrough.md) — three real traces as timelines. [`archive/`](design/archive/) — the superseded, larger "OpsDesk" design, kept for reference. |
